    ...
    <div class="section light" id="about">
      <div class="content">
        ...
        <div class="text" id="description-group">
          ...
          <!--DESCRIPTION-->
          <p>
          <code>Hello world</code>, my name is Leander Rodrigues and you've stumbled upon my landing page! Take some time to peruse my work and stay a while. So a little bit about me, I'm currently enrolled at the <em>University of Waterloo</em>, but I grew up in the suburbs of Mississauga, Ontario. I was accepted into this newfangled program, made only for the coolest of cats: <em>Nanotechnology Engineering</em>. It seemed like an obvious choice for someone like yours truly, since it sounds fancy, and I wanted to work with the latest and greatest in tech. As time goes by (I'm finishing up my second year!), it has definitely gone more towards the 'nano' and less towards the 'technology', so I figured now would be a good a time as any to pivot.</p><br />
          ...
          <br />
          <p>On the lighter side, I'm a pretty cool guy (if I do say so myself) outside of work. In my down time, you'll pretty much always catch me with headphones on. I'm either listening to tunez (mandatory letter  'z'), podcasts, or my friends scream at me in Discord. If you need someone to game with, someone to rip into bad movies with, or just someone to explain why dogs > cats, I'm definitely your guy. Aside from that, if I'm not going through a mountain of homework, working on a self-imposed project, or talking to/arguing with my friends online, It's pretty safe to say I'm asleep or dead.</p>
        </div>
