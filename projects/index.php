  ...
  <body>
    ...
    <div class="section light" id="preface">
      <div class="content">
        ...
        <p class="text-small">Welcome to my project dashboard! Here you can see an archive of all the programming projects that I've completed. They're sorted from newest to oldest.</p>
        <p class="text-small">These projects are all functional, but some may have less efficient, uglier code than others. I'm leaving those up so that in the long run, I have concrete evidence of my growth as a programmer (plus, I can look back on some of the source code and cringe at what I decided was 'good code'). Even now, I still have a lot to improve upon, but I guess I'm just going through my 'awkward teenage years' in my coding career.</p>
